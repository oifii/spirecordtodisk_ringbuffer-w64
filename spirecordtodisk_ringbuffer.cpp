...
int main(int argc, char *argv[])
{
	...
	//read in arguments
	///////////////////
	global_filename = "testrecording.w64"; //usage: spirecord testrecording.wav 10 "E-MU ASIO" 0 1
    ...
    printf("\n=== Now recording to '" FILE_NAME "' for %f seconds!! Please speak into the microphone. ===\n", fSecondsRecord); fflush(stdout);
